...
import net.lsanotes.ddz.ai.Player;
import net.lsanotes.ddz.card.Airplane;
import net.lsanotes.ddz.card.Bomb;
import net.lsanotes.ddz.card.BombType;
import net.lsanotes.ddz.card.Card;
import net.lsanotes.ddz.card.CardFactory;
import net.lsanotes.ddz.card.CardType;
import net.lsanotes.ddz.card.DoubleStraight;
import net.lsanotes.ddz.card.Pair;
import net.lsanotes.ddz.card.Rocket;
import net.lsanotes.ddz.card.Single;
import net.lsanotes.ddz.card.Straight;
import net.lsanotes.ddz.card.Three;
import net.lsanotes.ddz.res.Assets;
import net.lsanotes.ddz.res.GameGraphics;
import net.lsanotes.ddz.res.GlobalSoundPool;
import net.lsanotes.ddz.res.LiveBitmap;
//import net.lsanotes.ddz.test.SpecifiedHandCardGen;
import net.lsanotes.ddz.widget.BitmapButton;
import net.lsanotes.ddz.widget.BitmapButton.onClickListener;
import net.lsanotes.ddz.widget.GameScreen;
import net.lsanotes.ddz.widget.GameView;
import net.lsanotes.ddz.widget.MappedTouchEvent;
import net.lsanotes.ddz.util.PollingThread;
...
public class MainActivity extends FullScreenActivity implements GameScreen{
